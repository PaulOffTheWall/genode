/**
 * $Id: periodictask.h 815 2014-12-15 13:40:52Z klugeflo $
 * @file periodictask.h
...
namespace tmssim {
  ...
  public:
    PeriodicTask(unsigned int _id, int _period, int _et, int _ct,
		 UtilityCalculator* __uc, UtilityAggregator* __ua, int o=0, int _prio=1);
